aylar = {1:31, 2:00, 3:31, 4:30, 5:31, 6:30, 7:31, 8:31, 9:30, 10:31, 11:30, 12:31}    #dictionary metodu
...
if artikyil(yil) == True:
  ...
  aylar[2] = 28
for i in range(1, ay-1+1):    #içinde bulunduğumuz ay->ay+1, bir geriye dönmek için -1
  toplam += aylar[i]
toplam += gun
k = toplam - int(toplam/7) * 7
if k == 0: k=7     #kalan 0 çıkarsa kalanı 7 alır.
